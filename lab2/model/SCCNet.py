...
class SCCNet(nn.Module):
    def __init__(self, numClasses=0, timeSample=0, Nu=5, C=22, Nc=20, Nt=1, dropoutRate=0.5,Nf=1):
        '''
        ...
        self.conv2 = nn.Conv2d(in_channels=Nu, out_channels=Nc, kernel_size=(Nf, 12), stride=(1, 1))
        self.batch_norm2 = nn.BatchNorm2d(Nc)
        self.square = SquareLayer()
        
        self.dropout = nn.Dropout(p=dropoutRate)
        self.pool = nn.AvgPool2d((1,62),(1,12))
